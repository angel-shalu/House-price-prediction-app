...
model = pickle.load(open(r"C:\Users\shali\Desktop\Nit Data Science\6_Month_DS_Road_Map_2025\8. Machine Learning\Regression\MLR_House_Price_Predition\linear_regression_model.pkl",'rb'))
