...
mlr_model = pickle.load(open(r"C:\Users\shali\Desktop\Nit Data Science\6_Month_DS_Road_Map_2025\8. Machine Learning\Regression\MLR_House_Price_Predition\linear_regression_model.pkl",'rb'))
slr_model = pickle.load(open(r"C:\Users\shali\Desktop\Nit Data Science\6_Month_DS_Road_Map_2025\8. Machine Learning\Regression\SLR_House_Price_Prediction\linear_regression_model.pkl",'rb'))
...
if model_choice == "Multiple Linear Regression (MLR)":
    ...
    with st.container():
        ...
        bathroom = st.selectbox("Enter the Number of Bathrooms:", [1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 5], help="Choose number of bathrooms.")
